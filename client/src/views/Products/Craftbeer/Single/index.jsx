          ...
          <div className="product__page">
            ...
            <ul>
              {product.food_pairing.map(foodItem => (
                <Link to={`/products/craftbeer/${foodItem}`} key={Date.now() * Math.random()}>
                  <li>{foodItem}</li>
                </Link>
              ))}
            </ul>
            ...
            <ul>
              {product.ingredients.malt.map(malt => (
                <Link to={`/products/craftbeer/${malt.name}`} key={Date.now() * Math.random()}>
                  <li>
                    {malt.name}:{' '}
                    <em>
                      {' '}
            ...
            <ul>
              {product.ingredients.hops.map(hops => (
                <Link to={`/products/craftbeer/${hops.name}`} key={Date.now() * Math.random()}>
                  <li>
                    {hops.name}:{' '}
                    <em>
                      {' '}
            ...
            <ul>
              <Link
                to={`/products/craftbeer/${product.ingredients.yeast}`}
